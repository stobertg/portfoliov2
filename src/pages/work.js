...
import Wotr from '../images/wotr/treev2.jpg'
...
const Work = () => {
  ...
  const images = [
    ...
    { id: 4, image: Wotr, alt: "This is the Alt text" },
    { id: 5, image: Taa, alt: "This is the Alt text" },
    { id: 6, image: Misc, alt: "This is the Alt text" }
  ];
  ...
  return (
      ...
      <Fade>
        ...
        <div className="work__list">
            ...
            <li><Link onMouseEnter={ () => setImage( images[4].image ) } to="/wotr"><strong>Wars of the Roses</strong></Link></li>
            <li><Link onMouseEnter={ () => setImage( images[5].image ) } to="/taa"><strong>The Apparel Agency</strong></Link></li>
            <li><Link onMouseEnter={ () => setImage( images[6].image ) } to="/misc"><strong>Misc</strong></Link></li>
          </ul>
        </div>
      </Fade>
	  </PageWrap>
