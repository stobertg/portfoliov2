...
const Social = ( props ) => {
	return(
      ...
      <ul>
      	...
      	{ props.linkedIn
        	? <li>
		          <a href={ props.linkedIn } target="_blank" title="LinkedIn" rel="noreferrer">
        ...
        { props.instagram
        	? <li>
		          <a href={ props.instagram } target="_blank" class="instagram" title="Instagram" rel="noreferrer">
		            <svg viewBox="0 0 512 512">
		              <g>
      	...
      	{ props.dribbble 
      		? <li>
		          <a href={ props.dribbble } target="_blank" title="Dribbble" rel="noreferrer">
		            <svg viewBox="0 0 512 512">
        ...
        { props.behance 
        	? <li>
		          <a href={ props.behance } target="_blank" title="Behance" rel="noreferrer">
		            <svg viewBox="0 0 512 512">
        ...
        { props.medium
        	? <li>
		          <a href={ props.medium } class="rounded medium" target="_blank" rel="noreferrer">
        ...
        { props.codepen
        	? <li>
		          <a href={ props.codepen } target="_blank" title="CodePen" rel="noreferrer">
		            <svg viewBox="0 0 512 512">
        ...
        <li>
        	<a href="https://github.com/stobertg/portfoliov2" target="_blank" title="GitHub" rel="noreferrer">
        		<svg viewBox="0 0 512 512">
							<path class="st0" d="M256,9.1C116.2,9.1,2.8,122.4,2.8,262.3C2.8,374.1,75.4,469,176,502.5c12.7,2.3,17.3-5.5,17.3-12.2
