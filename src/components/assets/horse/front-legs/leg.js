...
class HorseLeg extends React.Component {
	render() {
		return(

			<div className={`horse__leg horse__leg--${this.props.position}`}>
				<div className="horse__leg--top"> 
					<svg viewBox="0 0 36.7 77.2">
						<g>
							<path class="st0" d="M9,38.5c0.8,3.5,1.7,12.3,2,14.8c0.3,2.4,0.4,11,0.2,15.3c-0.1,2.9,0.5,5.2,1,7.1c0,0,0.7,1.5,4.1,1.5
				...
				<div className="horse__leg--bottom">
					...
					<div className="horse__leg--foot">
						<svg viewBox="0 0 13.7 10.5">
							<g>
								<path class="st0" d="M12.9,3.9c-0.2,1.7,1.3,2.7,0.6,3.8s-1.9,1.8-3.2,2.2C9.1,10.2,0,11.1,0,9.9s1.4-3.6,2.8-5.1s1.3-1.3,1-1.7
