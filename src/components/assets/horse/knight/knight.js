  ...
  <div className="knight">
  	...
  	<div className="knight__main">
			<svg viewBox="0 0 305.8 524.9">
				<g>
					<g>
						<path class="knight__saddle" d="M85.4,290.3c0,0-12.3-3.3-21.8,16c-9.4,19.3-11.3,32-9.1,50.9s20.3,32,24.7,33.8c18.7,7.5,42.9,5.8,50.9,3.3
						...
						<path class="knight__saddle--light" d="M133.4,463.4c-0.4-5.4,3.1-44-0.9-57.9c-4-14-3.1-44.9-3.1-44.9s-41,2-48.9-10.2c-7.8-12.2-4-27.4-2.2-40.3
					...
					<path class="knight__person" d="M136,210.8c-0.7,1.7-3,7.4-5.1,17.6c-4.4,21.5,1.5,17.9-3.8,27.7c-5.3,9.9-24.7,45-12.5,39.6c16.3,6.1,22.3,2.5,22.3,2.5
					...
					<path class="knight__saddle--light" d="M140.3,520.8c0,0-13.8-21.6-13.2-38.7c0,0,2.1,2.2-3.3-0.9c-5.4-3.1,5.7,36,8.3,39.6
						C134.7,524.3,140.3,520.8,140.3,520.8z"/>
					<path class="knight__saddle--light" d="M124.6,519.9L145,521C145,521,138.9,530.5,124.6,519.9z"/>
				</g>
			</svg>
		</div>
	</div>
