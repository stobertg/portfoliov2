	...
	<div className="horse__base">
		<div className="horse__base--head">
			...
			<div className="horse__head--neck">
				<svg viewBox="0 0 74.4 70.2">
					<path class="st0" d="M24.5,0c5.6,2.6,5.9,3.5,9.2,4.9s14.2,7.5,20,11.8c0,0,13.7,7.5,19,10.8s-0.1,40.2-42.5,42.8
		...
		<div className="horse__base--body">
			<svg viewBox="0 0 161.8 78.2">
				<path class="st0" d="M155.6,56.5c4.5-6.7,5.5-15.1,6.1-19.9c0.6-4.8-0.7-14.5-1.9-16.1s-1.7-2.9-4.3-6.8c-2.7-3.8-5.1-6.1-10.8-8.5
