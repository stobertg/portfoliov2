				    		...
				    		<div className="animation__text">
				    			<div className="animation__text--multi">
							    	...
							    	{this.state.confirmText ?
							    		<div><strong>Confirm Screen</strong></div> : null
							    	}
							    </div>

						    	{this.state.statusText ?
						    		<div><strong>Status Screen</strong></div> : null
						    	}

						    	{this.state.chatText ?
						    		<div><strong>Chat Screen</strong></div> : null
						    	}
						    </div> : null
						  }
						  ...
						  {this.state.staticMode ?
							  <div className="animation__text">
						    	...
						    	{this.state.staticStatusText ?
						    		<div><strong>Static Mode</strong></div> : null
						    	}

						    	{this.state.staticContactsText ?
						    		<div><strong>Contacts Screen</strong></div> : null
						    	}

						    	{this.state.staticProfileText ?
							  		<div><strong>Profile Screen</strong></div> : null
						    	}

						    	{this.state.staticHelpText ?
							  		<div><strong>Call for Help</strong></div> : null
						    	}
				    		</div> : null
				    	}
			    	</PresentationTitle>
