		  ...
		  <pre>
			  ...
			  &gt;
				  ...
				  &nbsp;&nbsp;&nbsp;&nbsp;&lt;
				  	...
				  	<span className="lsg__code--green">class</span>
				  	<span className="lsg__code--red">=</span>
				  	<span className="lsg__code--yellow">"input__text-area"</span>
				  &gt;
					  ...
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;
					  	...
					  	&gt;<span>Notes to pharmacy staff</span>&lt;
					  	<span>/</span>
					  	<span className="lsg__code--red">label</span> 
					  &gt;
					  ...
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;
					  	...
					  	<span className="lsg__code--red">=</span>
					  	<span className="lsg__code--yellow">"Prompt text"</span>
					  	&gt;&lt;
					  	<span>/</span>
					  	<span className="lsg__code--red">textarea</span> 
					  &gt;
					  ...
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;
					  	...
					  	<span className="lsg__code--green">class</span>
					  	<span className="lsg__code--red">=</span>
					  	<span className="lsg__code--yellow">"character-count"</span>
